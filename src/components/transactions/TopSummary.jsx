...
const TopSummary = ({ onAddClick, onExport }) => {
    ...
    return (
        <div
            className={`relative overflow-hidden p-6 rounded-2xl h-[220px] transition-all
        ${darkMode
        ...
        >
            ...
            <div className="flex gap-3 mt-6">
                {role === "admin" && (
                    <button
                        onClick={onAddClick}
                        className="px-4 py-2 rounded-lg bg-[#d7793e] text-white"
                    >
                        New transfer
                    </button>
                )}
                ...
                <button
                    onClick={onExport}
                    className={`px-4 py-2 rounded-lg border ${darkMode ? "border-[#d7793e] text-[#d7793e] hover:bg-[#d7793e20]" : "border-[#b74d0b] text-[#b74d0b] hover:bg-[#d7793e41]"} transition`}
                >
                    Export CSV
                </button>
            </div>
            ...
            <motion.div
                ...
                className={`absolute right-24 top-10 w-50 h-34 rounded-xl p-4
          ...
          shadow-[0_0_25px_rgba(215,121,62,0.2)]`}
            ...
            <motion.div
                ...
                className={`absolute right-12 top-25 w-50 h-34 rounded-xl p-4
          bg-linear-to-br ${darkMode ? "from-[#ffffff20] to-[#d7793e20] backdrop-blur-md border border-white/10" : "from-[#d7793e7d] to-[#d7793e20] backdrop-blur-md border border-white/10"}
          shadow-[0_0_25px_rgba(215,121,62,0.2)]`}
            >
                <div className="text-xs opacity-70">Finicio</div>
